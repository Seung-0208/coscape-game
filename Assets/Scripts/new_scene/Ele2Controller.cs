...
public class Ele2Controller : MonoBehaviour
{
    ...
    void SetCamera()
    {
        ...
        if (curpos==cam2pos || curpos == cam4pos)
        {
            ...
            if (Cam1.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f&&curpos==cam2pos) {
                ...
                for (int i=0;i<obstacle.Length;i++) { //기둥들 위치 변경
                    ...
                    if (i==obstacle.Length-1) newPosition.x = playItem[0].position.x - 2.92f;
                    else if (i==obstacle.Length-2) newPosition.x = playItem[0].position.x - 2.92f;
                    else if (i==obstacle.Length-11) newPosition.x = playItem[0].position.x - 0.46f;
                    else if (i==obstacle.Length-10) newPosition.x = playItem[0].position.x + 6.01f;
                    else if (i==obstacle.Length-13) newPosition.x = playItem[0].position.x + 2f;
                ...
                for (int i=0;i<obstacle.Length;i++) {
                    newPosition = obstacle[i].position;
                    if (i==obstacle.Length-1 || i==obstacle.Length-2) newPosition.x = playItem[0].position.x - 2.72f;
                    else if (i==obstacle.Length-11) newPosition.x = playItem[0].position.x - 0.47f;
                    else if (i==obstacle.Length-13) newPosition.x = playItem[0].position.x + 2.01f;
                    else if (i==obstacle.Length-10) newPosition.x = playItem[0].position.x + 6.01f;
        ...
        else if (curpos == cam1pos || curpos == cam3pos)
        {
            ...
            if (Cam1.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f&&curpos==cam3pos) {
                ...
                for (int i=0;i<obstacle.Length;i++) {
                    newPosition = obstacle[i].position;
                    if (i==obstacle.Length-1) newPosition.z = playItem[0].position.z - 2.15f;
                    else if (i==obstacle.Length-2) newPosition.z = playItem[0].position.z - 2.15f;
                    else if (i==obstacle.Length-11) newPosition.z = playItem[0].position.z - 0.29f;
                    else if (i==obstacle.Length-10) newPosition.z = playItem[0].position.z + 5f;
                    else if (i==obstacle.Length-13) newPosition.z = playItem[0].position.z + 2f;
                ...
                for (int i=0;i<obstacle.Length;i++) {
                    newPosition = obstacle[i].position;
                    if (i==obstacle.Length-1 || i==obstacle.Length-2) newPosition.z = playItem[0].position.z - 2.17f;
                    else if (i==obstacle.Length-11) newPosition.z = playItem[0].position.z - 0.25f;
                    else if (i==obstacle.Length-10) newPosition.z = playItem[0].position.z + 5f;
                    else if (i==obstacle.Length-13) newPosition.z = playItem[0].position.z + 2f;
                    else newPosition.z = playItem[0].position.z;
                    obstacle[i].position = newPosition;
